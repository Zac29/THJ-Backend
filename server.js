...
app.use(
  cors({
    origin: ["http://localhost:5174","http://localhost:3000","tibetanhandicraftjewelleryv2.netlify.app","https://thjgaya.netlify.app","https://thjbodhgaya.netlify.app"], // your Vite port
    credentials: true,
  })
);
